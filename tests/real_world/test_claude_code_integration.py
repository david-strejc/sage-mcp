...
'''
            ...
            json.dump(
                {
                    ...
                    "query_params": {"search": "john", "page": 1, "limit": 50},
                    "slow_queries": [
                        {
        ...
        try:
            ...
            result = subprocess.run(
                [
                    ...
                    "--prompt",
                    "Analyze this bug report and suggest a fix approach.",
                    "--files",
                    self.test_scenarios["bug_report"],
                    "--mode",
                    "debug",
                    "--model",
                    "auto",
            ...
            assert any(
                word in output for word in ["validation", "email", "form"]
        ...
        try:
            result = subprocess.run(
                [
                    ...
                    str(self.project_root / "cli.py"),
                    "--prompt",
                    "Create an implementation plan for this feature specification.",
                    "--files",
                    self.test_scenarios["feature_spec"],
                    "--mode",
                    "plan",
                    "--model",
                    "auto",
            ...
            assert any(
                word in output for word in ["dark", "theme", "toggle", "css"]
        ...
        try:
            result = subprocess.run(
                [
                    ...
                    "--files",
                    self.test_scenarios["code_sample"],
                    "--mode",
                    "review",
                    "--model",
                    "auto",
            ...
            assert any(
                word in output for word in ["security", "hash", "password", "salt"]
    ...
    def test_realistic_scenario_performance_analysis(self):
        ...
        try:
            ...
            assert any(
                word in output for word in ["performance", "query", "index", "slow"]
        ...
        try:
            ...
            result1 = subprocess.run(
                [
                    ...
                    str(self.project_root / "cli.py"),
                    "--prompt",
                    "What's the main issue in this bug report?",
                    "--files",
                    self.test_scenarios["bug_report"],
                    "--mode",
                    "analyze",
            ...
            result2 = subprocess.run(
                [
                    ...
                    str(self.project_root / "cli.py"),
                    "--prompt",
                    "How would you fix the email validation issue?",
                    "--mode",
                    "chat",  # Continue without files
                ],
                capture_output=True,
                text=True,
                timeout=60,
        ...
        try:
            result = subprocess.run(
                [
                    ...
                    str(self.project_root / "cli.py"),
                    "--prompt",
                    "Review these files together - the bug report and the code that might be causing it.",
                    "--files",
                    self.test_scenarios["bug_report"],
                    self.test_scenarios["code_sample"],
                    "--mode",
            ...
            assert any(word in output for word in ["bug", "validation", "email"]), "Should reference bug report content"
            assert any(word in output for word in ["user", "authenticate", "password"]), "Should reference code content"
    ...
    def test_error_handling_scenario(self):
        ...
        try:
            ...
            if result.returncode != 0:
                ...
                assert any(
                    word in result.stdout.lower() for word in ["error", "not found", "missing"]
        ...
        try:
            ...
            result = subprocess.run(
                [
                    ...
                    str(self.project_root / "cli.py"),
                    "--prompt",
                    "Review this code for improvements and best practices.",
                    "--files",
                    main_file,
                    "--mode",
                    "review",
