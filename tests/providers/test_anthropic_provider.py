...
class TestAnthropicProvider:
    ...
    async def test_basic_text_completion(self):
        ...
        messages = [
            {"role": "user", "content": "Say 'Hello from Anthropic provider test' and nothing else."}
        ]
    ...
    async def test_claude_3_5_sonnet(self):
        ...
        messages = [
            {"role": "user", "content": "What's 25 * 4? Answer with just the number."}
        ]
    ...
    async def test_large_context_handling(self):
        ...
        messages = [
            {"role": "user", "content": f"Count how many times the word 'fox' appears in this text: {large_text}. Just give me the number."}
        ]
    ...
    async def test_tool_use_format(self):
        ...
        messages = [
            {"role": "user", "content": "If you had access to a calculator tool, how would you compute 123 * 456? Don't actually do the calculation, just explain how you'd use the tool."}
        ]
    ...
    async def test_error_handling(self):
        ...
        with pytest.raises(Exception):
            await self.provider.complete(
                messages=messages,
                model="nonexistent-claude-model-12345",
                temperature=0.5
            )
    ...
    async def test_temperature_variations(self):
        ...
        messages = [
            {"role": "user", "content": "Write a creative two-word phrase about coding."}
        ]
